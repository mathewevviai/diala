Title: GPU architecture documentation — ROCm Documentation

URL Source: https://rocm.docs.amd.com/en/latest/conceptual/gpu-arch.html

Markdown Content:
GPU architecture documentation — ROCm Documentation

===============

[Skip to main content](https://rocm.docs.amd.com/en/latest/conceptual/gpu-arch.html#main-content)
...
GPU architecture documentation[#](https://rocm.docs.amd.com/en/latest/conceptual/gpu-arch.html#gpu-architecture-documentation "Link to this heading")
=====================================================================================================================================================
...
*   [AMD Instinct™ MI300 microarchitecture](https://rocm.docs.amd.com/en/latest/conceptual/gpu-arch/mi300.html)
...
*   [AMD Instinct™ MI250 microarchitecture](https://rocm.docs.amd.com/en/latest/conceptual/gpu-arch/mi250.html)
...
*   [AMD Instinct™ MI100 microarchitecture](https://rocm.docs.amd.com/en/latest/conceptual/gpu-arch/mi100.html)
...
[previous Troubleshoot BAR access limitation](https://rocm.docs.amd.com/en/latest/how-to/Bar-Memory.html "previous page")[next AMD Instinct™ MI300 series microarchitecture](https://rocm.docs.amd.com/en/latest/conceptual/gpu-arch/mi300.html "next page")
...
*   [Cookie Settings](https://rocm.docs.amd.com/en/latest/conceptual/gpu-arch.html#cookie-settings)
