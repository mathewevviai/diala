Title: ROCm release history — ROCm Documentation

URL Source: https://rocm.docs.amd.com/en/latest/release/versions.html

Markdown Content:
ROCm release history — ROCm Documentation

===============

[Skip to main content](https://rocm.docs.amd.com/en/latest/release/versions.html#main-content)
...
ROCm release history[#](https://rocm.docs.amd.com/en/latest/release/versions.html#rocm-release-history "Link to this heading")
==============================================================================================================================
...
*   [Cookie Settings](https://rocm.docs.amd.com/en/latest/release/versions.html#cookie-settings)
