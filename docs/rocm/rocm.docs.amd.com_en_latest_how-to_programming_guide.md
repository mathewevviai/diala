Title: Programming guide — ROCm Documentation

URL Source: https://rocm.docs.amd.com/en/latest/how-to/programming_guide.html

Markdown Content:
Programming guide — ROCm Documentation

===============

[Skip to main content](https://rocm.docs.amd.com/en/latest/how-to/programming_guide.html#main-content)
...
Programming guide[#](https://rocm.docs.amd.com/en/latest/how-to/programming_guide.html#programming-guide "Link to this heading")
================================================================================================================================
...
OpenCL (Open Computing Language) is an open standard for cross-platform, parallel programming of diverse processors. ROCm supports OpenCL for developers who want to use standard frameworks across different hardware platforms, including CPUs, GPUs, and other accelerators. For more information, see [OpenCL](https://www.khronos.org/opencl/).
...
For a complete description of the HIP programming language, see the [HIP programming guide](https://rocm.docs.amd.com/projects/HIP/en/latest/index.html "(in HIP Documentation v6.4.43483)").
...
*   [Cookie Settings](https://rocm.docs.amd.com/en/latest/how-to/programming_guide.html#cookie-settings)
