Title: Use ROCm for AI inference — ROCm Documentation

URL Source: https://rocm.docs.amd.com/en/latest/how-to/rocm-for-ai/inference/index.html
...
[Skip to main content](https://rocm.docs.amd.com/en/latest/how-to/rocm-for-ai/inference/index.html#main-content)
...
Use ROCm for AI inference[#](https://rocm.docs.amd.com/en/latest/how-to/rocm-for-ai/inference/index.html#use-rocm-for-ai-inference "Link to this heading")
==========================================================================================================================================================
...
*   [Running models from Hugging Face](https://rocm.docs.amd.com/en/latest/how-to/rocm-for-ai/inference/hugging-face-models.html)
...
*   [Deploying your model](https://rocm.docs.amd.com/en/latest/how-to/rocm-for-ai/inference/deploy-your-model.html)

[previous Fine-tuning and inference using multiple accelerators](https://rocm.docs.amd.com/en/latest/how-to/rocm-for-ai/fine-tuning/multi-gpu-fine-tuning-and-inference.html "previous page")[next Running models from Hugging Face](https://rocm.docs.amd.com/en/latest/how-to/rocm-for-ai/inference/hugging-face-models.html "next page")
...
*   [Cookie Settings](https://rocm.docs.amd.com/en/latest/how-to/rocm-for-ai/inference/index.html#cookie-settings)
