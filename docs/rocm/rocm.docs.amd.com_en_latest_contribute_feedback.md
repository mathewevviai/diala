Title: Providing feedback about the ROCm documentation — ROCm Documentation

URL Source: https://rocm.docs.amd.com/en/latest/contribute/feedback.html

Markdown Content:
Providing feedback about the ROCm documentation — ROCm Documentation

===============

[Skip to main content](https://rocm.docs.amd.com/en/latest/contribute/feedback.html#main-content)
...
*   [Participating in discussions through GitHub Discussions](https://rocm.docs.amd.com/en/latest/contribute/feedback.html#participating-in-discussions-through-github-discussions)
*   [Submitting issues through GitHub Issues](https://rocm.docs.amd.com/en/latest/contribute/feedback.html#submitting-issues-through-github-issues)

Providing feedback about the ROCm documentation[#](https://rocm.docs.amd.com/en/latest/contribute/feedback.html#providing-feedback-about-the-rocm-documentation "Link to this heading")
=======================================================================================================================================================================================
...
Participating in discussions through GitHub Discussions[#](https://rocm.docs.amd.com/en/latest/contribute/feedback.html#participating-in-discussions-through-github-discussions "Link to this heading")
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Submitting issues through GitHub Issues[#](https://rocm.docs.amd.com/en/latest/contribute/feedback.html#submitting-issues-through-github-issues "Link to this heading")
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
For information about contributing content to the ROCm documentation, see [Contributing to the ROCm documentation](https://rocm.docs.amd.com/en/latest/contribute/contributing.html).

[previous Building documentation](https://rocm.docs.amd.com/en/latest/contribute/building.html "previous page")[next ROCm license](https://rocm.docs.amd.com/en/latest/about/license.html "next page")
...
*   [Cookie Settings](https://rocm.docs.amd.com/en/latest/contribute/feedback.html#cookie-settings)
