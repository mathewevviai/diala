Title: AMD Instinct™ MI100 microarchitecture — ROCm Documentation

URL Source: https://rocm.docs.amd.com/en/latest/conceptual/gpu-arch/mi100.html
...
[Skip to main content](https://rocm.docs.amd.com/en/latest/conceptual/gpu-arch/mi100.html#main-content)
...
*   [Microarchitecture](https://rocm.docs.amd.com/en/latest/conceptual/gpu-arch/mi100.html#microarchitecture)

AMD Instinct™ MI100 microarchitecture[#](https://rocm.docs.amd.com/en/latest/conceptual/gpu-arch/mi100.html#amd-instinct-mi100-microarchitecture "Link to this heading")
========================================================================================================================================================================
...
![Image 5: Structure of a single GCD in the AMD Instinct MI100 accelerator](https://rocm.docs.amd.com/en/latest/_images/image004.png)
...
Microarchitecture[#](https://rocm.docs.amd.com/en/latest/conceptual/gpu-arch/mi100.html#microarchitecture "Link to this heading")
---------------------------------------------------------------------------------------------------------------------------------
...
![Image 6: Structure of the AMD Instinct accelerator (MI100 generation)](https://rocm.docs.amd.com/en/latest/_images/image005.png)
...
![Image 7: Block diagram of an MI100 compute unit with detailed SIMD view of the AMD CDNA architecture](https://rocm.docs.amd.com/en/latest/_images/image006.png)
...
Peak-performance capabilities of MI100 for different data types.[#](https://rocm.docs.amd.com/en/latest/conceptual/gpu-arch/mi100.html#mi100-perf "Link to this table")| Computation and Data Type | FLOPS/CLOCK/CU | Peak TFLOPS |
| --- | --- | --- |
| Vector FP64 | 64 | 11.5 |
...
[previous AMD Instinct™ MI250 microarchitecture](https://rocm.docs.amd.com/en/latest/conceptual/gpu-arch/mi250.html "previous page")[next ROCm Linux Filesystem Hierarchy Standard reorganization](https://rocm.docs.amd.com/en/latest/conceptual/file-reorg.html "next page")
...
*   [Cookie Settings](https://rocm.docs.amd.com/en/latest/conceptual/gpu-arch/mi100.html#cookie-settings)
