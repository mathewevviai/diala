Title: AMD ROCm documentation — ROCm Documentation

URL Source: https://rocm.docs.amd.com/en/latest/
...
[Skip to main content](https://rocm.docs.amd.com/en/latest/#main-content)
...
AMD ROCm documentation[#](https://rocm.docs.amd.com/en/latest/#amd-rocm-documentation "Link to this heading")
=============================================================================================================
...
ROCm supports multiple programming languages and programming interfaces such as [HIP (Heterogeneous-Compute Interface for Portability)](https://rocm.docs.amd.com/projects/HIP/en/latest/index.html "(in HIP Documentation v6.4.43483)"), OpenCL, and OpenMP, as explained in the [Programming guide](https://rocm.docs.amd.com/en/latest/how-to/programming_guide.html).

If you’re using AMD Radeon™ PRO or Radeon GPUs in a workstation setting with a display connected, review [Radeon-specific ROCm documentation](https://rocm.docs.amd.com/projects/radeon/en/latest/index.html "(in Use ROCm™ on Radeon™ GPUs Documentation)").

ROCm documentation is organized into the following categories:

 Install

*   [ROCm on Linux](https://rocm.docs.amd.com/projects/install-on-linux/en/latest/reference/system-requirements.html "(in ROCm installation on Linux v6.4.1)")

*   [HIP SDK on Windows](https://rocm.docs.amd.com/projects/install-on-windows/en/latest/reference/system-requirements.html "(in HIP SDK installation on Windows v6.1.2)")

*   [ROCm on Radeon GPUs](https://rocm.docs.amd.com/projects/radeon/en/latest/index.html)

*   [Deep learning frameworks](https://rocm.docs.amd.com/en/latest/how-to/deep-learning-rocm.html)

*   [Build from source](https://rocm.docs.amd.com/en/latest/how-to/build-rocm.html)
...
*   [AMD Instinct MI300X performance validation and tuning](https://rocm.docs.amd.com/en/latest/how-to/tuning-guides/mi300x/index.html)
...
[next What is ROCm?](https://rocm.docs.amd.com/en/latest/what-is-rocm.html "next page")
...
*   [Cookie Settings](https://rocm.docs.amd.com/en/latest/#cookie-settings)
