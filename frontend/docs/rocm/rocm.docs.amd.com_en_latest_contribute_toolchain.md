Title: ROCm documentation toolchain — ROCm Documentation

URL Source: https://rocm.docs.amd.com/en/latest/contribute/toolchain.html

Markdown Content:
ROCm documentation toolchain — ROCm Documentation

===============

[Skip to main content](https://rocm.docs.amd.com/en/latest/contribute/toolchain.html#main-content)
...
*   [rocm-docs-core](https://rocm.docs.amd.com/en/latest/contribute/toolchain.html#rocm-docs-core)
*   [Sphinx](https://rocm.docs.amd.com/en/latest/contribute/toolchain.html#sphinx)
    *   [Sphinx External ToC](https://rocm.docs.amd.com/en/latest/contribute/toolchain.html#sphinx-external-toc)
    *   [Sphinx-book-theme](https://rocm.docs.amd.com/en/latest/contribute/toolchain.html#sphinx-book-theme)
    *   [Sphinx Design](https://rocm.docs.amd.com/en/latest/contribute/toolchain.html#sphinx-design)

*   [Doxygen](https://rocm.docs.amd.com/en/latest/contribute/toolchain.html#doxygen)
*   [Breathe](https://rocm.docs.amd.com/en/latest/contribute/toolchain.html#breathe)
*   [Read the Docs](https://rocm.docs.amd.com/en/latest/contribute/toolchain.html#read-the-docs)

ROCm documentation toolchain[#](https://rocm.docs.amd.com/en/latest/contribute/toolchain.html#rocm-documentation-toolchain "Link to this heading")
==================================================================================================================================================
...
rocm-docs-core[#](https://rocm.docs.amd.com/en/latest/contribute/toolchain.html#rocm-docs-core "Link to this heading")
----------------------------------------------------------------------------------------------------------------------
...
See the user and developer guides for rocm-docs-core at [rocm-docs-core documentation](https://rocm.docs.amd.com/projects/rocm-docs-core/en/latest/index.html "(in ROCm Docs Core v1.20.1)").

Sphinx[#](https://rocm.docs.amd.com/en/latest/contribute/toolchain.html#sphinx "Link to this heading")
------------------------------------------------------------------------------------------------------
...
### Sphinx External ToC[#](https://rocm.docs.amd.com/en/latest/contribute/toolchain.html#sphinx-external-toc "Link to this heading")
...
### Sphinx-book-theme[#](https://rocm.docs.amd.com/en/latest/contribute/toolchain.html#sphinx-book-theme "Link to this heading")
...
### Sphinx Design[#](https://rocm.docs.amd.com/en/latest/contribute/toolchain.html#sphinx-design "Link to this heading")
...
Doxygen[#](https://rocm.docs.amd.com/en/latest/contribute/toolchain.html#doxygen "Link to this heading")
--------------------------------------------------------------------------------------------------------
...
Breathe[#](https://rocm.docs.amd.com/en/latest/contribute/toolchain.html#breathe "Link to this heading")
--------------------------------------------------------------------------------------------------------

[Breathe](https://www.breathe-doc.org/) is a Sphinx plugin for integrating Doxygen content.

Read the Docs[#](https://rocm.docs.amd.com/en/latest/contribute/toolchain.html#read-the-docs "Link to this heading")
--------------------------------------------------------------------------------------------------------------------
...
[previous Contributing to the ROCm documentation](https://rocm.docs.amd.com/en/latest/contribute/contributing.html "previous page")[next Building documentation](https://rocm.docs.amd.com/en/latest/contribute/building.html "next page")
...
*   [Do Not Sell or Share My Personal Information](https://rocm.docs.amd.com/en/latest/contribute/toolchain.html#cookie-settings)
...
This website uses cookies and other tracking technologies to enhance user experience and to analyze performance and traffic on our website. We also share information about your use of our site with our social media, advertising and analytics partners. If a [Do Not Sell or Share My Personal Information](https://rocm.docs.amd.com/en/latest/contribute/toolchain.html#cookiesettings) preference is detected it will be honored. Further information is available in our [Cookies Policy](https://www.amd.com/en/legal/cookies.html) and [Privacy Notice](https://www.amd.com/en/legal/privacy.html).
