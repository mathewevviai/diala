...
class SettingsManager {
    ...
    initializeElements() {
        ...
        this.elements = {
            ...
            elevenLabsApiKeyInput: this.dialog.querySelector('#elevenLabsApiKey'),
    ...
    setupEventListeners() {
        ...
        this.elements.saveBtn.addEventListener('click', () => {
            this.saveSettings();
            this.hide();
            console.debug('[SettingsManager] Reloading page after save.');
    ...
    loadSettings() {
        ...
        this.elements.elevenLabsApiKeyInput.value = localStorage.getItem('elevenLabsApiKey') || '';
    ...
    saveSettings() {
        ...
        localStorage.setItem('elevenLabsApiKey', this.elements.elevenLabsApiKeyInput.value);
        console.debug('[SettingsManager] Saved ElevenLabs API Key:', this.elements.elevenLabsApiKeyInput.value ? 'Exists' : 'Not Found');
